...
function Main() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setShowIcons(window.scrollY < 100); // hide if scrolled more than 100px
    };
  ...
  return (
    <div className='px-35 pt-35'>
      ...
      {/* Social Icons that hide on scroll */}
      <div
        className={`fixed bottom-12 right-10 flex flex-col items-center gap-5 z-50 transition-opacity duration-900 ${
